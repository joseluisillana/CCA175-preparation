...
object LogSQL {
  ...
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("LogSQL").setMaster("local[*]").set("spark.sql.warehouse.dir",
      "file:///Users/joseluisillanaruiz/ZZ_Trabajo/ZZ_Repositorios/GitPersonal/CCA175-preparation/04_SPARK_STREAMING-PROJECT/udemy-course/Chapter5/tmp")
    ...
    // Kick it off
    ssc.checkpoint("checkpointLogSQL")
    ssc.start()
