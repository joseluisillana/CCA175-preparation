...
object StructuredStreaming {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession
      ...
      .master("local[*]")
      .config("spark.sql.warehouse.dir", "file:////Users/joseluisillanaruiz/ZZ_Trabajo/ZZ_Repositorios/GitPersonal" +
       "/CCA175-preparation/04_SPARK_STREAMING-PROJECT/udemy-course/Chapter5/tmp") // Necessary to work around a
    // Windows bug in Spark 2.0.0; omit if you're not on Windows.
      .config("spark.sql.streaming.checkpointLocation", "file:////Users/joseluisillanaruiz/ZZ_Trabajo/ZZ_Repositorios/GitPersonal/CCA175-preparation/04_SPARK_STREAMING-PROJECT/udemy-course/Chapter5/tmp/checkpoint")
      .getOrCreate()
