// ORM class for table 'departments_test_jl'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Sat Dec 10 01:24:30 UTC 2016
...
public class departments_test_jl extends SqoopRecord  implements DBWritable, Writable {
  ...
  public departments_test_jl with_department_id(Integer department_id) {
    this.department_id = department_id;
    return this;
  }
  ...
  public departments_test_jl with_department_name(String department_name) {
    this.department_name = department_name;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof departments_test_jl)) {
      return false;
    }
    departments_test_jl that = (departments_test_jl) o;
    boolean equal = true;
...
this.readFields0(__dataIn);  }
  ...
  private static final DelimiterSet __inputDelimiters = new DelimiterSet((char) 65533, (char) 10, (char) 0, (char) 0, false);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("-1") || __cur_str.length() == 0) { this.department_id = null; } else {
      this.department_id = Integer.valueOf(__cur_str);
    }

    __cur_str = __it.next();
    if (__cur_str.equals("nvl")) { this.department_name = null; } else {
  ...
  public Object clone() throws CloneNotSupportedException {
    departments_test_jl o = (departments_test_jl) super.clone();
    return o;
  }

  public void clone0(departments_test_jl o) throws CloneNotSupportedException {
  }
